---
title: "DAG 4 - reworking - Low SR, Low RR"
author: "Evelyn Tay"
date: "`r Sys.Date()`"
output: 
...
\text{If R_{i} then} D_{i} \sim \text{Bern}(h_{i}) \\
...
\alpha_{p}, \alpha_{q}, \alpha_{g}, \alpha_{h} \sim Normal(0.5, \sigma) \\
...
mod2_mod <- rstan::sampling(mod2, data = dat1,iter = 2500, warmup = 1000, chains = 2, refresh = FALSE, show_messages = FALSE)
...
mod2a_mod <- rstan::sampling(mod2, data = dat0,iter = 2500, warmup = 1000, chains = 2, refresh = FALSE, show_messages = FALSE)
