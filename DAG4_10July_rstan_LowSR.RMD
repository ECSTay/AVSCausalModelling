---
title: "DAG 4 - reworking - Low prev SR"
author: "Evelyn Tay"
date: "`r Sys.Date()`"
output: 
...
Younger people are more likely to react to a vaccine and have an immune response than older people. Moderate to highly severe reactions, i.e. $S_i = 1$ were reported more often by younger vaccine recipients ( 16 to 55 years) than by older ($/gt$55 years) in a phase II-III trial of a COVID19 vaccine. We are assuming low prevalances of a moderate to highly severe vaccine reaction in this scenario.
